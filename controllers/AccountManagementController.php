...
class AccountManagementController {
    ...
    public function getCustomerStatistics() {
        ...
        // New customers this month - use fetch() for date function
        $firstDayOfMonth = date('Y-m-01');
        $newThisMonth = fetch($this->customerTable, "DATE(created_at) >= '$firstDayOfMonth'");
        ...
        // Top customer by order count - use fetch() for JOIN with GROUP BY
        global $connection;
        ...
        $topCustomer = $result ? mysqli_fetch_assoc($result) : null;
